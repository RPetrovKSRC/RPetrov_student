...
public class MessageProcessor {
    ...
    private Stack undoStack; // операции для undo
    private Deque queue; // список операций
    ...
    private void undo(int steps) {
        Message popedMessage = (Message)undoStack.pop();
        for (int i = 0; i < steps ; i++) {
           // queue.
            System.out.println("Undo message: " + popedMessage);
        }
